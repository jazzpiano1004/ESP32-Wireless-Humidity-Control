...
void drawFreeText(int x, int y, int text_color)
{
  // Create an 8 bit sprite 70x 80 pixels (uses 5600 bytes of RAM)
  img.setColorDepth(8);
  img.createSprite(120, 100);
  ...
  img.setTextColor(text_color, TFT_BLACK);  // White text, no background colour  
  img.setFreeFont(FF24);
  img.setTextSize(1);
  img.drawString("Hello", 10, 10, GFXFF);
